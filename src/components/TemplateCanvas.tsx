...
export const TemplateCanvas: React.FC<TemplateCanvasProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Field Styling Panel */}
      {selectedFieldData && selectedFieldData.field_type === 'field' && (
        <Card className="p-4">
          <h4 className="font-medium text-slate-800 mb-3">Field Styling</h4>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleFieldUpdate(selectedField!, { font_size: parseInt(e.target.value) })}
                min="8"
                max="72"
              />
            </div>
